...
class CustomerRidesPreview extends StatelessWidget {
                              ...
                              children: [
                                ...
                                TableRow(children: [
                                  ...
                                  const TableCell(
                                      child: Padding(
                                    padding: EdgeInsets.all(8.0),
                                    child: Text('Cancel Penality - '),
                                  )),
                                  TableCell(
                                      child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(cancelPenalty.toString()),
                                  )),
                                ]),
                                TableRow(children: [
                                  const TableCell(
